...
#include "function.h"
extern int dep,sco;
void play(SDL_Surface* ecran,SDL_Surface *niv,int macs)
{
    int continuer=1;
    SDL_Event event;
    SDL_Rect posgri,pos;
    ...
    score(ecran,0);
    nbdepla(ecran,0,macs);
    while (continuer&&macs-dep>0)
    {
        ...
        case SDL_MOUSEBUTTONUP:
                ...
                //line 0 col 0
            {
                ...
                {
                    swaap(ecran,0,0,1,0,niv);
                    po=-1;
                }
                if(po==1&& cas(0,1,event) )

                {
                    swaap(ecran,0,0,0,1,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,0,1,0,0,niv);
                    po=-1;
                }
                if(po==2&& cas(1,1,event) )
                {
                    swaap(ecran,0,1,1,1,niv);
                    po=-1;
                }
                if(po==2&& cas(0,2,event) )
                {
                    swaap(ecran,0,1,0,2,niv);
                    po=-1;
                }
...
//line 0 col 2
                ...
                {
                    swaap(ecran,0,2,0,1,niv);
                    po=-1;
                }
                if(po==3&&cas(1,2,event) )
                {
                    swaap(ecran,0,2,1,2,niv);
                    po=-1;
                }
                if(po==3&& cas(0,3,event) )
                {
                    swaap(ecran,0,2,0,3,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,0,3,0,2,niv);
                    po=-1;
                }
                if(po==4&&  cas(1,3,event) )
                {
                    swaap(ecran,0,3,1,3,niv);
                    po=-1;
                }
                if(po==4&& cas(0,4,event) )
                {
                    swaap(ecran,0,3,0,4,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,0,4,0,3,niv);
                    po=-1;
                }
                if(po==5&&cas(1,4,event) )
                {
                    swaap(ecran,0,4,1,4,niv);
                    po=-1;
                }
                if(po==5&& cas(0,5,event) )
                {
                    swaap(ecran,0,4,0,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,0,5,0,4,niv);
                    po=-1;
                }
                if(po==6&& cas(1,5,event) )
                {
                    swaap(ecran,0,5,1,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,1,0,0,0,niv);
                    po=-1;
                }
                if(po==7&& cas(2,0,event) )
                {
                    swaap(ecran,1,0,2,0,niv);
                    po=-1;
                }
                if(po==7&& cas(1,1,event) )
                {
                    swaap(ecran,1,0,1,1,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,1,1,0,1,niv);
                    po=-1;
                }
                if(po==8&&cas(1,0,event) )
                {
                    swaap(ecran,1,1,1,0,niv);
                    po=-1;
                }
                if(po==8&&cas(2,1,event) )
                {
                    swaap(ecran,1,1,2,1,niv);
                    po=-1;
                }
                if(po==8&&cas(1,2,event) )
                {
                    swaap(ecran,1,1,1,2,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,1,2,0,2,niv);
                    po=-1;
                }
                if(po==9&&cas(1,1,event) )
                {
                    swaap(ecran,1,2,1,1,niv);
                    po=-1;
                }
                if(po==9&& cas(2,2,event) )
                {
                    swaap(ecran,1,2,2,2,niv);
                    po=-1;
                }
                if(po==9&& cas(1,3,event) )
                {
                    swaap(ecran,1,2,1,3,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,1,3,0,3,niv);
                    po=-1;
                }
                if(po==10&& cas(1,2,event) )
                {
                    swaap(ecran,1,3,1,2,niv);
                    po=-1;
                }
                if(po==10&&cas(2,3,event))
                {
                    swaap(ecran,1,3,2,3,niv);
                    po=-1;
                }
                if(po==10&& cas(1,4,event) )
                {
                    swaap(ecran,1,3,1,4,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,1,4,0,4,niv);
                    po=-1;
                }
                if(po==11&& cas(1,3,event) )
                {
                    swaap(ecran,1,4,1,3,niv);
                    po=-1;
                }
                if(po==11&&cas(2,4,event) )
                {
                    swaap(ecran,1,4,2,4,niv);
                    po=-1;
                }
                if(po==11&& cas(1,5,event))
                {
                    swaap(ecran,1,4,1,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,1,5,0,5,niv);
                    po=-1;
                }
                if(po==12&& cas(1,4,event) )
                {
                    swaap(ecran,1,5,1,4,niv);
                    po=-1;
                }
                if(po==12&& cas(2,5,event) )
                {
                    swaap(ecran,1,5,2,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,2,0,1,0,niv);
                    po=-1;
                }
                if(po==13&& cas(3,0,event) )
                {
                    swaap(ecran,2,0,3,0,niv);
                    po=-1;
                }
                if(po==13&& cas(2,1,event) )
                {
                    swaap(ecran,2,0,2,1,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,2,1,1,1,niv);
                    po=-1;
                }
                if(po==14&&cas(2,0,event))
                {
                    swaap(ecran,2,1,2,0,niv);
                    po=-1;
                }
                if(po==14&&cas(3,1,event) )
                {
                    swaap(ecran,2,1,3,1,niv);
                    po=-1;
                }
                if(po==14&& cas(2,2,event) )
                {
                    swaap(ecran,2,1,2,2,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,2,2,1,2,niv);
                    po=-1;
                }
                if(po==15&& cas(2,1,event))
                {
                    swaap(ecran,2,2,2,1,niv);
                    po=-1;
                }
                if(po==15&& cas(3,2,event) )
                {
                    swaap(ecran,2,2,3,2,niv);
                    po=-1;
                }
                if(po==15&& cas(2,3,event))
                {
                    swaap(ecran,2,2,2,3,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,2,3,1,3,niv);
                    po=-1;
                }
                if(po==16&&cas(2,2,event) )
                {
                    swaap(ecran,2,3,2,2,niv);
                    po=-1;
                }
                if(po==16&& cas(3,3,event) )
                {
                    swaap(ecran,2,3,3,3,niv);
                    po=-1;
                }
                if(po==16&&cas(2,4,event) )
                {
                    swaap(ecran,2,3,2,4,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,2,4,1,4,niv);
                    po=-1;
                }
                if(po==17&& cas(2,3,event) )
                {
                    swaap(ecran,2,4,2,3,niv);
                    po=-1;
                }
                if(po==17&&cas(3,4,event))
                {
                    swaap(ecran,2,4,3,4,niv);
                    po=-1;
                }
                if(po==17&& cas(2,5,event) )
                {
                    swaap(ecran,2,4,2,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,2,5,1,5,niv);
                    po=-1;
                }
                if(po==18&&cas(2,4,event))
                {
                    swaap(ecran,2,5,2,4,niv);
                    po=-1;
                }
                if(po==18&& cas(3,5,event) )
                {
                    swaap(ecran,2,5,3,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,3,0,3,1,niv);
                    po=-1;
                }
                if(po==19&&cas(4,0,event) )
                {
                    swaap(ecran,3,0,4,0,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,3,1,2,1,niv);
                    po=-1;
                }
                if(po==20&& cas(3,0,event) )
                {
                    swaap(ecran,3,1,3,0,niv);
                    po=-1;
                }
                if(po==20&&cas(4,1,event) )
                {
                    swaap(ecran,3,1,4,1,niv);
                    po=-1;
                }
                if(po==20&&cas(3,2,event))
                {
                    swaap(ecran,3,1,3,2,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,3,2,2,2,niv);
                    po=-1;
                }
                if(po==21&& cas(3,1,event) )
                {
                    swaap(ecran,3,2,3,1,niv);
                    po=-1;
                }
                if(po==21&& cas(4,2,event))
                {
                    swaap(ecran,3,2,4,2,niv);
                    po=-1;
                }
                if(po==21&&cas(3,3,event) )
                {
                    swaap(ecran,3,2,3,3,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,3,3,2,3,niv);
                    po=-1;
                }
                if(po==22&&cas(3,2,event) )
                {
                    swaap(ecran,3,3,3,2,niv);
                    po=-1;
                }
                if(po==22&& cas(4,3,event) )
                {
                    swaap(ecran,3,3,4,3,niv);
                    po=-1;
                }
                if(po==22&& cas(3,4,event) )
                {
                    swaap(ecran,3,3,3,4,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,3,4,2,4,niv);
                    po=-1;
                }
                if(po==23&&cas(3,3,event))
                {
                    swaap(ecran,3,4,3,3,niv);
                    po=-1;
                }
                if(po==23&&cas(4,4,event) )
                {
                    swaap(ecran,3,4,4,4,niv);
                    po=-1;
                }
                if(po==23&& cas(3,5,event) )
                {
                    swaap(ecran,3,4,3,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,3,5,2,5,niv);
                    po=-1;
                }
                if(po==24&& cas(3,4,event) )
                {
                    swaap(ecran,3,5,3,4,niv);
                    po=-1;
                }
                if(po==24&& cas(4,5,event) )
                {
                    swaap(ecran,3,5,4,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,4,0,3,0,niv);
                    po=-1;
                }
                if(po==25&&cas(4,1,event) )
                {
                    swaap(ecran,4,0,4,1,niv);
                    po=-1;
                }
                if(po==25&& cas(5,0,event) )
                {
                    swaap(ecran,4,0,5,0,niv);
                    po=-1;
                }
...
// ligne 4 colonne 1
                ...
                {
                    swaap(ecran,4,1,3,1,niv);
                    po=-1;
                }
                if(po==26&&cas(4,0,event) )
                {
                    swaap(ecran,4,1,4,0,niv);
                    po=-1;
                }
                if(po==26&& cas(5,1,event) )
                {
                    swaap(ecran,4,1,5,1,niv);
                    po=-1;
                }
                if(po==26&&cas(4,2,event) )
                {
                    swaap(ecran,4,1,4,2,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,4,2,3,2,niv);
                    po=-1;
                }
                if(po==27&&cas(4,1,event) )
                {
                    swaap(ecran,4,2,4,1,niv);
                    po=-1;
                }
                if(po==27&& cas(5,2,event) )
                {
                    swaap(ecran,4,2,5,2,niv);
                    po=-1;
                }
                if(po==27&& cas(4,3,event) )
                {
                    swaap(ecran,4,2,4,3,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,4,3,3,3,niv);
                    po=-1;
                }
                if(po==28&& cas(4,2,event) )
                {
                    swaap(ecran,4,3,4,2,niv);
                    po=-1;
                }
                if(po==28&&cas(5,3,event))
                {
                    swaap(ecran,4,3,5,3,niv);
                    po=-1;
                }
                if(po==28&& cas(4,4,event) )
                {
                    swaap(ecran,4,3,4,4,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,4,4,3,4,niv);
                    po=-1;
                }
                if(po==29&&cas(4,3,event))
                {
                    swaap(ecran,4,4,4,3,niv);
                    po=-1;
                }
                if(po==29&& cas(5,4,event))
                {
                    swaap(ecran,4,4,5,4,niv);
                    po=-1;
                }
                if(po==29&&cas(4,5,event) )
                {
                    swaap(ecran,4,4,4,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,4,5,3,5,niv);
                    po=-1;
                }
                if(po==30&& cas(4,4,event) )
                {
                    swaap(ecran,4,5,4,4,niv);
                    po=-1;
                }
                if(po==30&& cas(5,5,event) )
                {
                    swaap(ecran,4,5,5,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,5,0,4,0,niv);
                    po=-1;
                }
                if(po==31&& cas(5,1,event) )
                {
                    swaap(ecran,5,0,5,1,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,5,1,4,1,niv);
                    po=-1;
                }
                if(po==32&& cas(5,0,event))
                {
                    swaap(ecran,5,1,5,0,niv);
                    po=-1;
                }
                if(po==32&&cas(5,2,event) )
                {
                    swaap(ecran,5,1,5,2,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,5,2,4,2,niv);
                    po=-1;
                }
                if(po==33&&cas(5,1,event) )
                {
                    swaap(ecran,5,2,5,1,niv);
                    po=-1;
                }
                if(po==33&&cas(5,3,event) )
                {
                    swaap(ecran,5,2,5,3,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,5,3,4,3,niv);
                    po=-1;
                }
                if(po==34&&cas(5,2,event) )
                {
                    swaap(ecran,5,3,5,2,niv);
                    po=-1;
                }
                if(po==34&& cas(5,4,event) )
                {
                    swaap(ecran,5,3,5,4,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,5,4,4,4,niv);
                    po=-1;
                }
                if(po==35&& cas(5,3,event) )
                {
                    swaap(ecran,5,4,5,3,niv);
                    po=-1;
                }
                if(po==35&&cas(5,5,event) )
                {
                    swaap(ecran,5,4,5,5,niv);
                    po=-1;
                }
                ...
                {
                    swaap(ecran,5,5,4,5,niv);
                    po=-1;
                }
                if(po==36&&cas(5,4,event) )
                {
                    swaap(ecran,5,5,5,4,niv);
                    po=-1;
                }
